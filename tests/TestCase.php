...
class TestCase extends BaseTestCase
{
    ...
    public function createApplication()
    {
        ...
        $app->booting(function () {
            ...
            $loader->alias('Admin', \Sirius\Builder\Facades\Admin::class);
        });

        $app->make('Illuminate\Contracts\Console\Kernel')->bootstrap();

        $app->register('Sirius\Builder\AdminServiceProvider');
    ...
    public function setUp()
    {
        ...
        $this->artisan('vendor:publish', ['--provider' => 'Sirius\Builder\AdminServiceProvider']);
