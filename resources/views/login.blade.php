...
<head>
  ...
  <title>{{config('admin.title')}} | {{ lang('admin.login') }}</title>
...
<div class="login-box">
  ...
  <div class="login-box-body">
    <p class="login-box-msg">{{ lang('admin.login') }}</p>
    ...
    <form action="{{ admin_base_path('auth/login') }}" method="post">
      <div class="form-group has-feedback {!! !$errors->has('username') ?: 'has-error' !!}">
        ...
        <input type="input" class="form-control" placeholder="{{ lang('admin.username') }}" name="username" value="{{ old('username') }}">
